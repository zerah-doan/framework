...
import pageobject.backend.AdvertisingPage;
import pageobject.backend.LoginPage;
import test.BaseTest;
import util.Log;
import util.Random;

public class UC60 extends BaseTest {
	WebActions wa;
	...
	@Test
	public void UC60_AdvertisingUser() {
		AdvertisingPage page = new AdvertisingPage(driver);
		page.goToPage();

		// Add
		String company = "Company " + Random.randomNumber(3);
		page.addAdvertising(company, Random.randomString(5) + " St", Random.randomNumber(5),
		...
		page.editAdvertising(company, editedCompany, Random.randomString(5) + " St", Random.randomNumber(5),
				Random.randomString(10) + " City", Random.randomNumber(10),
				"email" + Random.randomNumber(5) + "@abc.com");
		...
		// Delete
		page.deleteAdvertising(editedCompany);
