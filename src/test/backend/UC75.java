...
import pageobject.backend.TubeProductPage;
import test.BaseTest;
import util.Log;
import util.Random;

public class UC75 extends BaseTest {
	WebActions wa;
	...
	@Test
	public void UC70_TubeProduct() {
		TubeProductPage page = new TubeProductPage(driver);
		page.goToPage();
