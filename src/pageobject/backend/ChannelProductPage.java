...
public class ChannelProductPage {
	@FindBy(xpath = "//*[@id='channels-grid']//a[./text()='Add New Product']")
	private WebElement btnSaveCat;

	@FindBy(xpath = "//*[@id='channels-grid']//table//tr[1]/td[@data-container-for='language']/span")
	private WebElement drpLanguage;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='article_nr']")
	private WebElement txtProdNum;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='name']")
	private WebElement txtProdName;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='field_1']")
	private WebElement txtField1;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='field_2']")
	private WebElement txtField2;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='field_3']")
	private WebElement txtField3;
	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='field_4']")
	private WebElement txtField4;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='field_5']")
	private WebElement txtField5;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='field_6']")
	private WebElement txtField6;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='option_1']")
	private WebElement txtOption1;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='option_2']")
	private WebElement txtOption2;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='option_3']")
	private WebElement txtOption3;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='option_4']")
	private WebElement txtOption4;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='option_5']")
	private WebElement txtOption5;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]//input[@name='option_6']")
	private WebElement txtOption6;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]/td[@data-container-for='type_1']/span")
	private WebElement drpType1;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]/td[@data-container-for='type_2']/span")
	private WebElement drpType2;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]/td[@data-container-for='type_3']/span")
	private WebElement drpType3;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]/td[@data-container-for='type_4']/span")
	private WebElement drpType4;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]/td[@data-container-for='type_5']/span")
	private WebElement drpType5;

	@FindBy(xpath = "// *[@id='channels-grid']//table//tr[1]/td[@data-container-for='type_6']/span")
	private WebElement drpType6;

	@FindBy(xpath = "//*[@id='channels-grid']//a[./text()='Update']")
	private WebElement btnUpdate;

	@FindBy(xpath = "//*[@id='channels-grid']//a[./text()='Cancel']")
	private WebElement btnCancelUpdate;

	private WebActions action;

	public ChannelProductPage(WebDriver driver) {
		PageFactory.initElements(driver, this);
		this.action = new WebActions(driver);
	}

	public void goToPage() {
		action.click(By.xpath("//*[@id='proair-nav-bar']/ul/li[./a/text()='Products: Channels']"));
	...
	public void addProduct(String lang, String prodNum, String prodName) {
		Log.logInfo("Add channel product: ");
	...
	public void editProduct(String oldProdName, String newProdName, String newProdNum) {
		Log.logInfo("Edit channel product: " + oldProdName);
	...
	public boolean isProductExisting(String prodName) {
		return action.isDisplayed(By.xpath("//*[@id='channels-grid']//tr[.//text()='" + prodName + "']"));
	}

	public boolean isProductNotExisting(String prodName) {
		return action.isNotDisplayed(By.xpath("//*[@id='channels-grid']//tr[.//text()='" + prodName + "']"));
	}

	public void clickEditProduct(String prodName) {
		action.click(By.xpath("//*[@id='channels-grid']//tr[.//text()='" + prodName + "']//a[./text()='Edit']"));
	}

	public void deleteProduct(String prodName) {
		Log.logInfo("Delete product: " + prodName);
		action.click(By.xpath("//*[@id='channels-grid']//tr[.//text()='" + prodName + "']//a[./text()='Delete']"));
